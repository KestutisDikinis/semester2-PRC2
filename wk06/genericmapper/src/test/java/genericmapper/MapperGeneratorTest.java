...
public class MapperGeneratorTest {
    ...
    static Stream<Arguments> testData2() {
        return Stream.of(
                ...
                arguments( 7,
                        s( "public", "class", "StudentMapper", "extends","Mapper<Student,","Integer>", "{" ) ),
                ...
                arguments( 33, s("public","Function<Student,","Integer>", "keyExtractor()" )),
                arguments( 34, s("return","(","Student","s","->", "s.getSnummer();" )),
